...
namespace BankRateAggregator.Application.Services.Currency
{
    public class CurrencyParserService : ICurrencyParserService
    {
        ...
        public async Task<List<Rate>?> WebScrapping(string url, string xPath, int bankId, List<CurrencyIdValuePair> currencies, CancellationToken cancellationToken)
        {
        ...
        public async Task<List<Rate>?> ApiCallJson(BaseApiModel model, string url, int bankId, List<CurrencyIdValuePair> currencies, CancellationToken cancellationToken)
        {
        ...
        public async Task<List<Rate>?> ApiCallXml(BaseApiXMLModel model, string url, int bankId, List<CurrencyIdValuePair> currencies, CancellationToken cancellationToken)
        {
